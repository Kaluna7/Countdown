export function InputButton({onClick, value, onAdd}){
    return(
        <div className="text-white flex flex-col gap-5 items-center">
            <input type="text" placeholder="Enter Your Name" className="border focus:border-2 focus:outline-none border-green-600 px-8 py-2 rounded-lg" value={value} onChange={onAdd}/>
